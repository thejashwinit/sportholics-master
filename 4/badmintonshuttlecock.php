  ...
  <body>
    ...
    <div class="others">
      <ul>
        ...
        <li><a href="badmintonkits.php">Kits</a></li>
        <li><a href="badmintonnets.php">Nets</a></li>
        <li><a href="badmintonracquets.php">Racquets</a></li>
        <li><a href="badmintonshuttlecock.php">Shuttlecock</a></li>
      </ul>
    </div>
    <div class="contents">
    <?php
    $db = mysqli_connect("localhost","root","","sportholics");
    $sql = "SELECT * FROM product where pcategory='badminton' and ptype='shuttlecock';";
    $result = mysqli_query($db,$sql);
    echo "<ul class='product-list-basic'>";
    while($row = mysqli_fetch_array($result))
    {
    echo "<li>";
    echo "<form action='badmintonshuttlecock.php' method='POST'>";
