  ...
  <body>
    ...
    <div class="others">
      <ul>
        ...
        <li><a href="footballbibs.php">Bibs</a></li>
        <li><a href="footballfootballs.php">Footballs</a></li>
        <li><a href="footballgloves.php">Gloves</a></li>
        <li><a href="footballkits.php">Kits</a></li>
        <li><a href="footballnets.php">Nets</a></li>
        <li><a href="footballoutfits.php">Outfits</a></li>
      </ul>
    </div>
    <div class="contents">
    <?php
    $db = mysqli_connect("localhost","root","","sportholics");
    $sql = "SELECT * FROM product where pcategory='football' and ptype='footballs';";
    $result = mysqli_query($db,$sql);
    echo "<ul class='product-list-basic'>";
    while($row = mysqli_fetch_array($result))
    {
    echo "<li>";
    echo "<form action='footballfootballs.php' method='POST'>";
