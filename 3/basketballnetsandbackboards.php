  ...
  <body>
    ...
    <div class="others">
      <ul>
        ...
        <li><a href="basketballbasketballs.php">Basketballs</a></li>
        <li><a href="basketballinflatingpins.php">Inflating Pins</a></li>
        <li><a href="basketballnetsandbackboards.php">Nets and Backboards</a></li>
        <li><a href="basketballpumps.php">Pumps</a></li>
      </ul>
    </div>
    <div class="contents">
    <?php
    $db = mysqli_connect("localhost","root","","sportholics");
    $sql = "SELECT * FROM product where pcategory='basketball' and ptype='netsandbackboards';";
    $result = mysqli_query($db,$sql);
    echo "<ul class='product-list-basic'>";
    while($row = mysqli_fetch_array($result))
    {
    echo "<li>";
    echo "<form action='basketballnetsandbackboards.php' method='POST'>";
