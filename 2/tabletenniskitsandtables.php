  ...
  <body>
    ...
    <div class="others">
      <ul>
        ...
        <li><a href="tabletennisballs.php">Balls</a></li>
        <li><a href="tabletenniskitsandtables.php">Kits and Tables</a></li>
        <li><a href="tabletennisnetsandtapes.php">Nets and Tapes</a></li>
        <li><a href="tabletennisracquets.php">Racquets</a></li>
      </ul>
    </div>
    <div class="contents">
    <?php
    $db = mysqli_connect("localhost","root","","sportholics");
    $sql = "SELECT * FROM product where pcategory='tabletennis' and ptype='kitsandtables';";
    $result = mysqli_query($db,$sql);
    echo "<ul class='product-list-basic'>";
    while($row = mysqli_fetch_array($result))
    {
    echo "<li>";
    echo "<form action='tabletenniskitsandtables.php' method='POST'>";
