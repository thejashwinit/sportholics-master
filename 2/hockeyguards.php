  ...
  <body>
    ...
    <div class="others">
      <ul>
        ...
        <li><a href="hockeyballs.php">Balls</a></li>
        <li><a href="hockeygloves.php">Gloves</a></li>
        <li><a href="hockeyguards.php">Guards</a></li>
        <li><a href="hockeysticks.php">Sticks</a></li>
      </ul>
    </div>
    <div class="contents">
    <?php
    $db = mysqli_connect("localhost","root","","sportholics");
    $sql = "SELECT * FROM product where pcategory='hockey' and ptype='guards';";
    $result = mysqli_query($db,$sql);
    echo "<ul class='product-list-basic'>";
    while($row = mysqli_fetch_array($result))
    {
    echo "<li>";
    echo "<form action='hockeyguards.php' method='POST'>";
