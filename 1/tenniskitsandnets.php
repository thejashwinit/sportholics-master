    ...
    ?>
      <div class="others">
        <ul>
          ...
          <li><a href="tennisballs.php">Balls</a></li>
          <li><a href="tennisgrips.php">Grips</a></li>
          <li><a href="tenniskitsandnets.php">Kits and Nets</a></li>
          <li><a href="tennisracquets.php">Racquets</a></li>
        </ul>
      </div>
      <div class="contents">
    <?php
    $db = mysqli_connect("localhost","root","","sportholics");
    $sql = "SELECT * FROM product where pcategory='tennis' and ptype='kitsandnets';";
    $result = mysqli_query($db,$sql);
    echo "<ul class='product-list-basic'>";
    while($row = mysqli_fetch_array($result))
    {
    echo "<li>";
    echo "<form action='tenniskitsandnets.php' method='POST'>";
