    ...
    ?>
      <div class="others">
        <ul>
          ...
          <li><a href="volleyballvolleyballs.php">Volleballs</a></li>
          <li><a href="volleyballnets.php">Nets</a></li>
          <li><a href="volleyballinflatingpins.php">Inflating Pins</a></li>
        </ul>
      </div>
      <div class="contents">
    <?php
    $db = mysqli_connect("localhost","root","","sportholics");
    $sql = "SELECT * FROM product where pcategory='volleyball' and ptype='inflatingpins';";
    $result = mysqli_query($db,$sql);
    echo "<ul class='product-list-basic'>";
    while($row = mysqli_fetch_array($result))
    {
    echo "<li>";
    echo "<form action='volleyballinflatingpins.php' method='POST'>";
